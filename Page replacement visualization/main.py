...
# Theory of PRA
def theory():
    python_path = "C:\Program Files\MySQL\MySQL Workbench 8.0 CE\python.exe"  # Provide the full path to your Python interpreter
    file_path = "C:\Users\lenovo\Downloads\Theory.py"  # Path to the Python script
